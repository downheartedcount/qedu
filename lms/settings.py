...
ALLOWED_HOSTS = ['q-edu.kz', 'www.q-edu.kz']
CSRF_TRUSTED_ORIGINS = ['http://89.46.34.193', 'https://q-edu.kz', 'https://www.q-edu.kz']
...
STATICFILES_STORAGE = 'lms.storage.WhiteNoiseStaticFilesStorage'
