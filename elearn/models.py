...
class Course(models.Model):
    ...
    synopsis = models.TextField(null=True, max_length=100)
    is_shown = models.BooleanField(default=False)
    thumb = models.ImageField(upload_to='', default='no-img.jpg', blank=True)
    students = models.ManyToManyField(User, default='')
    trainer = models.CharField(null=True, max_length=50, default='')
